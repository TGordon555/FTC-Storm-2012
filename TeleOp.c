...
void omniDrive(int joyx, int joyy)
{
 /* motor[motorD] =*/ motor[motorE] = (100.0/128*joyx + 100.0/128*joyy)/sqrt(2);
 /* motor[motorF] =*/ motor[motorG] = (100.0/128*-joyx + 100.0/128*joyy)/sqrt(2);
 writeDebugStreamline("(%d, %d)", motor[motorE], motor[motorG])
